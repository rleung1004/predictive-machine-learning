def example():
    ...
    PATH = "../datasets/small_cats_and_dogs/"
...
def exercise():
    ...
    PATH = "../datasets/small_cats_and_dogs_and_octopi/"
    ...
    def create_model(X_train, y_train, X_test, y_test):
        ...
        # Create output layer which has three classes.
    ...
    for i in range(0, len(predictions)):
        prediction = predictions[i]
        predictionList.append(np.argmax(prediction))
